...
model_5 <- lm.cluster(effect100 ~ major_party_general + primary + race_media0to1SQRT + race_has_incumbent + mov0to1SQRT, 
           data = nh_meta_analysis, cluster = "RaceID") %>% summary()
